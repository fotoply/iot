...
public class IoTPackageImpl extends EPackageImpl implements IoTPackage
{
   ...
   * @generated
   */
  private EClass serverFromTypeEClass = null;
   ...
   */
  @Override
  public EReference getDevice_Group()
  {
  ...
  {
    return (EAttribute)deviceGroupEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getDeviceGroup_Devices()
  {
   ...
   */
  @Override
  public EClass getServerFromType()
  {
    return serverFromTypeEClass;
  }
   ...
   */
  @Override
  public EAttribute getServerFromType_Name()
  {
    return (EAttribute)serverFromTypeEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getServerFromType_Type()
  {
    return (EReference)serverFromTypeEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getServer_Lip()
  {
   ...
   */
  @Override
  public EReference getServer_Sip()
  {
   ...
   */
  @Override
  public EReference getServer_Group()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(deviceEClass, DEVICE__GROUP);

    deviceGroupEClass = createEClass(DEVICE_GROUP);
    createEAttribute(deviceGroupEClass, DEVICE_GROUP__NAME);
    createEReference(deviceGroupEClass, DEVICE_GROUP__DEVICES);
    ...
    serverFromTypeEClass = createEClass(SERVER_FROM_TYPE);
    createEAttribute(serverFromTypeEClass, SERVER_FROM_TYPE__NAME);
    createEReference(serverFromTypeEClass, SERVER_FROM_TYPE__TYPE);

    serverEClass = createEClass(SERVER);
    createEAttribute(serverEClass, SERVER__NAME);
    createEReference(serverEClass, SERVER__LIP);
    createEReference(serverEClass, SERVER__SIP);
    createEReference(serverEClass, SERVER__GROUP);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getDevice_Group(), this.getSensorGroup(), null, "group", null, 0, 1, Device.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDeviceGroup_Devices(), this.getDevice(), null, "devices", null, 0, -1, DeviceGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(serverFromTypeEClass, ServerFromType.class, "ServerFromType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getServerFromType_Name(), ecorePackage.getEString(), "name", null, 0, 1, ServerFromType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getServerFromType_Type(), this.getServerType(), null, "type", null, 0, 1, ServerFromType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getServer_Lip(), this.getPortnumber(), null, "lip", null, 0, 1, Server.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getServer_Sip(), this.getPortnumber(), null, "sip", null, 0, 1, Server.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getServer_Group(), this.getDeviceGroup(), null, "group", null, 0, 1, Server.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getPortnumber_Number(), ecorePackage.getEString(), "number", null, 0, 1, Portnumber.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
