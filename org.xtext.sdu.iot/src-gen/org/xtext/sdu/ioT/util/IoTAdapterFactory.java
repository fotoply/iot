...
public class IoTAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected IoTSwitch<Adapter> modelSwitch =
    new IoTSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseServerFromType(ServerFromType object)
      {
        return createServerFromTypeAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.sdu.ioT.DeviceGroup <em>Device Group</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.xtext.sdu.ioT.ServerFromType <em>Server From Type</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createServerFromTypeAdapter()
  {
    return null;
  }
