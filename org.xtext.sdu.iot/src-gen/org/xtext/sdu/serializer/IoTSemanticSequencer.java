...
import org.xtext.sdu.ioT.ServerFromType;
...
public class IoTSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == IoTPackage.eINSTANCE)
			...
			case IoTPackage.DEVICE:
				...
				return; 
			case IoTPackage.DEVICE_GROUP:
				sequence_DeviceGroup(context, (DeviceGroup) semanticObject); 
				return; 
			...
			case IoTPackage.SERVER:
				...
				return; 
			case IoTPackage.SERVER_FROM_TYPE:
				sequence_ServerFromType(context, (ServerFromType) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     DeviceGroup returns DeviceGroup
	 *
	 * Constraint:
	 *     (name=ID devices+=[Device|ID] devices+=[Device|ID]*)
	 */
	protected void sequence_DeviceGroup(ISerializationContext context, DeviceGroup semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (type=[DeviceType|ID] group=[SensorGroup|ID])
	 */
	protected void sequence_Device(ISerializationContext context, Device semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, IoTPackage.Literals.DEVICE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IoTPackage.Literals.DEVICE__TYPE));
			if (transientValues.isValueTransient(semanticObject, IoTPackage.Literals.DEVICE__GROUP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IoTPackage.Literals.DEVICE__GROUP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDeviceAccess().getTypeDeviceTypeIDTerminalRuleCall_2_0_1(), semanticObject.eGet(IoTPackage.Literals.DEVICE__TYPE, false));
		feeder.accept(grammarAccess.getDeviceAccess().getGroupSensorGroupIDTerminalRuleCall_4_0_1(), semanticObject.eGet(IoTPackage.Literals.DEVICE__GROUP, false));
		feeder.finish();
	}
	...
	protected void sequence_Portnumber(ISerializationContext context, Portnumber semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPortnumberAccess().getNumberNUMBERTerminalRuleCall_1_0(), semanticObject.getNumber());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     ServerFromType returns ServerFromType
	 *
	 * Constraint:
	 *     (name=ID type=[ServerType|ID])
	 */
	protected void sequence_ServerFromType(ISerializationContext context, ServerFromType semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, IoTPackage.Literals.SERVER_FROM_TYPE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IoTPackage.Literals.SERVER_FROM_TYPE__NAME));
			if (transientValues.isValueTransient(semanticObject, IoTPackage.Literals.SERVER_FROM_TYPE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IoTPackage.Literals.SERVER_FROM_TYPE__TYPE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getServerFromTypeAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getServerFromTypeAccess().getTypeServerTypeIDTerminalRuleCall_3_0_1(), semanticObject.eGet(IoTPackage.Literals.SERVER_FROM_TYPE__TYPE, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID lip=Portnumber sip=Portnumber group=[DeviceGroup|ID])
	 */
	protected void sequence_Server(ISerializationContext context, Server semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, IoTPackage.Literals.SERVER__LIP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IoTPackage.Literals.SERVER__LIP));
			if (transientValues.isValueTransient(semanticObject, IoTPackage.Literals.SERVER__SIP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IoTPackage.Literals.SERVER__SIP));
			if (transientValues.isValueTransient(semanticObject, IoTPackage.Literals.SERVER__GROUP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IoTPackage.Literals.SERVER__GROUP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getServerAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getServerAccess().getLipPortnumberParserRuleCall_5_0(), semanticObject.getLip());
		feeder.accept(grammarAccess.getServerAccess().getSipPortnumberParserRuleCall_9_0(), semanticObject.getSip());
		feeder.accept(grammarAccess.getServerAccess().getGroupDeviceGroupIDTerminalRuleCall_11_0_1(), semanticObject.eGet(IoTPackage.Literals.SERVER__GROUP, false));
		feeder.finish();
	}
	...
	protected void sequence_Time(ISerializationContext context, Time semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getTimeAccess().getTimeNUMBERTerminalRuleCall_0(), semanticObject.getTime());
		feeder.finish();
	}
