...
public class IoTParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, IoTGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFetchDataAccess().getAlternatives_5(), "rule__FetchData__Alternatives_5");
			builder.put(grammarAccess.getFetchDataAccess().getAlternatives_6(), "rule__FetchData__Alternatives_6");
			...
			builder.put(grammarAccess.getSensorGroupAccess().getGroup_5(), "rule__SensorGroup__Group_5__0");
			...
			builder.put(grammarAccess.getDeviceGroupAccess().getGroup(), "rule__DeviceGroup__Group__0");
			builder.put(grammarAccess.getDeviceGroupAccess().getGroup_5(), "rule__DeviceGroup__Group_5__0");
			...
			builder.put(grammarAccess.getServerFromTypeAccess().getGroup(), "rule__ServerFromType__Group__0");
			...
			builder.put(grammarAccess.getFetchDataAccess().getGroup_5_0(), "rule__FetchData__Group_5_0__0");
			builder.put(grammarAccess.getFetchDataAccess().getGroup_5_1(), "rule__FetchData__Group_5_1__0");
			...
			builder.put(grammarAccess.getSensorGroupAccess().getSensorsAssignment_4(), "rule__SensorGroup__SensorsAssignment_4");
			builder.put(grammarAccess.getSensorGroupAccess().getSensorsAssignment_5_1(), "rule__SensorGroup__SensorsAssignment_5_1");
			...
			builder.put(grammarAccess.getMethodAccess().getParametersAssignment_2(), "rule__Method__ParametersAssignment_2");
			builder.put(grammarAccess.getMethodAccess().getParametersAssignment_3_1(), "rule__Method__ParametersAssignment_3_1");
			...
			builder.put(grammarAccess.getDeviceAccess().getTypeAssignment_2(), "rule__Device__TypeAssignment_2");
			builder.put(grammarAccess.getDeviceAccess().getGroupAssignment_4(), "rule__Device__GroupAssignment_4");
			builder.put(grammarAccess.getDeviceGroupAccess().getNameAssignment_1(), "rule__DeviceGroup__NameAssignment_1");
			builder.put(grammarAccess.getDeviceGroupAccess().getDevicesAssignment_4(), "rule__DeviceGroup__DevicesAssignment_4");
			builder.put(grammarAccess.getDeviceGroupAccess().getDevicesAssignment_5_1(), "rule__DeviceGroup__DevicesAssignment_5_1");
			...
			builder.put(grammarAccess.getServerFromTypeAccess().getNameAssignment_1(), "rule__ServerFromType__NameAssignment_1");
			builder.put(grammarAccess.getServerFromTypeAccess().getTypeAssignment_3(), "rule__ServerFromType__TypeAssignment_3");
			builder.put(grammarAccess.getServerAccess().getNameAssignment_1(), "rule__Server__NameAssignment_1");
			builder.put(grammarAccess.getServerAccess().getLipAssignment_5(), "rule__Server__LipAssignment_5");
			builder.put(grammarAccess.getServerAccess().getSipAssignment_9(), "rule__Server__SipAssignment_9");
			builder.put(grammarAccess.getServerAccess().getGroupAssignment_11(), "rule__Server__GroupAssignment_11");
			...
			builder.put(grammarAccess.getFetchDataAccess().getDestinationAssignment_5_0_1(), "rule__FetchData__DestinationAssignment_5_0_1");
			builder.put(grammarAccess.getFetchDataAccess().getDestinationAssignment_5_1_1(), "rule__FetchData__DestinationAssignment_5_1_1");
			builder.put(grammarAccess.getFetchDataAccess().getConExpAssignment_6_0(), "rule__FetchData__ConExpAssignment_6_0");
			builder.put(grammarAccess.getFetchDataAccess().getConExpAssignment_6_1(), "rule__FetchData__ConExpAssignment_6_1");
